...
<li class="catesItemR"{{-- v-show="loadedItem"--}}>
    ...
    <a href="{{url("shop/$product->c_url/$product->url")}}" class="text-dark" style="text-decoration: none;">
        <div class="innerCatesItemR"
             style="background-image: url('{{asset("/_img/bg_items_white.png")}}');    background-size: cover;">
            ...
            <div class="partA">
                ...
                <div class="frameItemPrices">
                    @if($product->prev_price)<span
                        style="text-decoration: line-through; margin-inline-end: 20px;">${{$product['prev_price']}}</span>@endif
