                                        ...
                                        <div class="entry-content-page">
                                            ...
                                            <section class="kc-elm kc-css-344016 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-12361 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
                                                                <div
                                                                    class="kc-elm kc-css-582254 kc-title-wrap no-border ">
                                            ...
                                            <section class="kc-elm kc-css-652456 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-239892 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
                                            ...
                                            <section class="kc-elm kc-css-197227 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-725978 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
                                            ...
                                            <section class="kc-elm kc-css-379142 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-898321 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
                                                                <div id=" "
                                                                     class="kc-elm kc-css-735309 kc_row kc_row_inner">
                                                                    <div
                                                                        class="kc-elm kc-css-848757 kc_col-sm-6 kc_column_inner kc_col-sm-6">
                                                                        <div class="kc_wrapper kc-col-inner-container">
                                                                            <div
                                                                                class="kc_shortcode kc_single_image effect-v8">
                                                                                <img
                                                                                    src="{{asset('_img/layout/about_us1.jpg')}}"
                                                                                    class="" alt="banner"/></div>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        class="kc-elm kc-css-949724 kc_col-sm-6 kc_column_inner kc_col-sm-6">
                                                                        <div class="kc_wrapper kc-col-inner-container">
                                                                            <div
                                                                                class="kc-elm kc-css-979187 kc-title-wrap no-border ">

                                                                                <h3 class="kc_title">{{$lists['about'][1]->title}}</h3>
                                                                            </div>

                                                                            <div
                                                                                class="kc-elm kc-css-427451 divider_line">
                                                                                <div
                                                                                    class="divider_inner divider_line1">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="kc-elm kc-css-619783 kc_text_block">
                                                                                {!!$lists['about'][1]->options->article->value !!}
                                                                            </div>
                                                                            <div id=" "
                                                                                 class="kc-elm kc-css-274792 kc_row kc_row_inner">
                                                                                <div
                                                                                    class="kc-elm kc-css-726227 kc_col-sm-6 kc_column_inner kc_col-sm-6">
                                                                                    <div
                                                                                        class="kc_wrapper kc-col-inner-container">
                                                                                        <div
                                                                                            class="kc-elm kc-css-711636 kc-title-wrap no-border ">

                                                                                            <h3 class="kc_title">{{$lists['about'][2]->title}}</h3>
                                                                                        </div>

                                                                                        <div
                                                                                            class="kc-elm kc-css-171864 divider_line">
                                                                                            <div
                                                                                                class="divider_inner divider_line1">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div
                                                                                            class="kc-elm kc-css-928399 kc_text_block">
                                                                                            {!!$lists['about'][2]->options->article->value !!}
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="kc-elm kc-css-366075 kc_col-sm-6 kc_column_inner kc_col-sm-6">
                                                                                    <div
                                                                                        class="kc_wrapper kc-col-inner-container">
                                                                                        <div
                                                                                            class="kc-elm kc-css-172671 kc-title-wrap no-border ">

                                                                                            <h3 class="kc_title">{{$lists['about'][3]->title}}</h3>
                                                                                        </div>

                                                                                        <div
                                                                                            class="kc-elm kc-css-696246 divider_line">
                                                                                            <div
                                                                                                class="divider_inner divider_line1">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div
                                                                                            class="kc-elm kc-css-241548 kc_text_block">
                                            ...
                                            <section class="kc-elm kc-css-933099 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-325435 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
                                            ...
                                            <section class="kc-elm kc-css-277214 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-355680 kc_col-sm-3 kc_column kc_col-sm-3">
                                                            <div class="kc-col-container">
                                                        ...
                                                        <div
                                                            class="kc-elm kc-css-315790 kc_col-sm-3 kc_column kc_col-sm-3">
                                                            <div class="kc-col-container">
                                                        ...
                                                        <div
                                                            class="kc-elm kc-css-533444 kc_col-sm-3 kc_column kc_col-sm-3">
                                                            <div class="kc-col-container">
                                                        ...
                                                        <div
                                                            class="kc-elm kc-css-691125 kc_col-sm-3 kc_column kc_col-sm-3">
                                                            <div class="kc-col-container">
                                            ...
                                            <section class="kc-elm kc-css-605558 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-276217 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
                                            ...
                                            <section class="kc-elm kc-css-940086 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-923455 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
                                                                <div id=" "
                                                                     class="kc-elm kc-css-851040 kc_row kc_row_inner">
                                                                    <div
                                                                        class="kc-elm kc-css-500708 kc_col-sm-6 kc_column_inner kc_col-sm-6">
                                                                        <div class="kc_wrapper kc-col-inner-container">
                                                                            <div
                                                                                class="kc-elm kc-css-499737 kc-title-wrap no-border ">

                                                                                <h3 class="kc_title">{{$lists['about'][4]->title}}</h3>
                                                                            </div>

                                                                            <div
                                                                                class="kc-elm kc-css-581060 divider_line">
                                                                                <div
                                                                                    class="divider_inner divider_line1">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="kc-elm kc-css-317751 kc_text_block">
                                                                                {!!$lists['about'][4]->options->article->value !!}
                                                                            </div>
                                                                            <div class="kc-elm kc-css-311473"
                                                                                 style="height: 40px; clear: both; width:100%;"></div>
                                                                            <div
                                                                                class="kc-elm kc-css-160890 kc-title-wrap no-border ">

                                                                                <h3 class="kc_title">Contact Info</h3>
                                                                            </div>

                                                                            <div
                                                                                class="kc-elm kc-css-277038 divider_line">
                                                                                <div
                                                                                    class="divider_inner divider_line1">
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="kc-elm kc-css-985123 kc_box_wrap ">
                                                                    ...
                                                                    <div
                                                                        class="kc-elm kc-css-429683 kc_col-sm-6 kc_column_inner kc_col-sm-6">
                                                                        <div class="kc_wrapper kc-col-inner-container">
                                                                            <div
                                                                                class="kc_shortcode kc_single_image effect-v8">
                                                                                <img
                                                                                    src="{{asset('_img/layout/about_us2.jpg')}}"
                                                                                    class="" alt="banner"/></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                            ...
                                            <section class="kc-elm kc-css-573623 kc_row">
                                                <div class="kc-row-container  kc-container">
                                                    <div class="kc-wrap-columns">
                                                        <div
                                                            class="kc-elm kc-css-277130 kc_col-sm-12 kc_column kc_col-sm-12">
                                                            <div class="kc-col-container">
