...
*/                            ])
                        <ul>
                            @foreach ($userLinks as $item)
                                <li class="{{active($item->url != 'user/profile'?$item->url:[$item->url,'user'])}}"><a
                                        href="{{url($item->url)}}"><i class="{{$item->icon}}"></i> {{$item->title}}</a>
                                </li>
                            @endforeach
                            <li class="">
                                <a href="#">
...
@section('style')
    <style>
        ...
        @font-face {
            ...
            src: url({{asset('fonts/themify.eot?#iefix-fvbane')}}) format('embedded-opentype'), url({{asset('fonts/themify.woff?-fvbane')}}) format('woff'), url(../fonts/themify.ttf?-fvbane) format('truetype'), url({{asset('fonts/themify.svg?-fvbane#themify')}}) format('svg')
        }
