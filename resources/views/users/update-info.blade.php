    ...
    <div class="f-row">
        <div class="col-12 col-md-5">
            <div class="profile-thumb"
                 style="background-image: url('{{asset('_img/profiles/'.$user->profile_img)}}');width: initial; max-width: 100%;"></div>
            <form class="profile-thumb-upload mt-15" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                    ...
                    @if($errors->has('profile_img'))
                        <div class="text-danger">{{$errors->first('profile_img')}}</div> @endif
